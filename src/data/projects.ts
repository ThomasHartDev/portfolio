...
export const projects: Project[] = [
  {
    ...
    description:
      "A production SaaS platform for image optimization — format conversion, SSIM-based compression, and batch processing. Handles conversions with Stripe billing, R2 storage, Upstash Redis rate limiting, and a polished conversion interface.",
    longDescription:
      "PixelWand started as a tool I needed myself — a fast, no-nonsense image optimizer that could handle bulk conversions without quality loss. It uses SSIM (Structural Similarity Index) to guarantee perceptual quality while maximizing compression. The pipeline processes images through WebP, AVIF, and PNG optimization with Sharp. The backend handles presigned URL uploads to Cloudflare R2, server-side processing, and automatic cleanup. Stripe handles subscriptions with usage-based billing. Free tier users get 3 conversions/day enforced by Upstash Redis rate limiting.",
    techStack: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
  ...
  },
  {
    ...
    description:
      "A scientifically-grounded tool for visualizing how couples perceive their relationships. Features a quiz-based assessment, 3D particle body maps rendered with Three.js, and multi-layer D3.js radar charts comparing self-perception vs. partner perception.",
    longDescription:
      "Perception grew out of an interest in how people experience relationships differently. Partners take a quiz independently, then the system scores responses across 8 relationship dimensions (trust, attraction, communication, security, etc.) and visualizes gaps between self-image and partner perception. The 3D body map uses React Three Fiber to render 400+ colored particles mapped to body regions — inspired by Nummenmaa et al. (2014) research on bodily maps of emotions. D3.js draws multi-layer radar charts overlaying self, partner, and meta-perception scores. The Fastify backend handles auth (magic links + OAuth), sessions, and partner invites, with Prisma/Postgres storing all quiz data. localStorage provides offline fallback.",
    techStack: [
      "Next.js",
      "TypeScript",
      "Three.js",
    ...
    highlights: [
      ...
      { title: "Research-Backed", description: "Grounded in psychology research on bodily maps of emotions and empathic accuracy" },
      { title: "Full-Stack", description: "Fastify API with magic link auth, Prisma/Postgres, and localStorage offline fallback" },
      { title: "Monorepo", description: "Turborepo workspace with shared scoring package, separate web and server deployments" },
    ],
    year: "2025–2026",
    status: "active",
    architecture: {
  ...
  },
  {
    ...
    description:
      "An ecommerce platform for curated office products and workspace accessories. Features product reviews with photos, affiliate integration, order tracking, and a clean shopping experience focused on workspace aesthetics.",
    longDescription:
      "Office Aesthetics is an ecommerce platform built around the idea that your workspace should look and feel intentional. The product catalog is curated — not a dump of everything on Amazon — with editorial reviews, bundle recommendations, and workspace inspiration galleries. The platform handles affiliate product linking, order tracking with shipping and tax, and a review system with photo uploads. Klaviyo tracks order events for email marketing and Facebook Conversions API handles purchase attribution. Built with Nuxt 3 for SSR and MongoDB for the product catalog with flexible schema for different product categories.",
    techStack: [
      "Nuxt 3",
      "Vue 3",
      "TypeScript",
    ...
    highlights: [
      ...
      { title: "User Accounts", description: "Google and email auth, order history, and review management per user" },
  ...
  },
  {
    ...
    highlights: [
      ...
      { title: "User System", description: "Accounts with Google and email auth, order history, and saved preferences" },
  ...
  },
  {
    ...
    description:
      "The marketing site for Subsource Software — a custom software consultancy. Features service breakdowns, case studies with real metrics from shipped projects, a contact form for project inquiries, FAQ section, and polished scroll animations throughout.",
    longDescription:
      "This is the client-facing site for Subsource Software — designed to convert visitors into clients. The site features detailed service pages for web apps, mobile, AI, and system integrations. Case studies showcase real client metrics from shipped projects. The contact form collects project scope, budget range, and details upfront. The design emphasizes credibility with smooth Framer Motion animations, clean typography, and social proof throughout.",
    techStack: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
